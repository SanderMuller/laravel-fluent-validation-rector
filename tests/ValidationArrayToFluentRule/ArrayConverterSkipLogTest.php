...
namespace SanderMuller\FluentValidationRector\Tests\ValidationArrayToFluentRule;
 ...
 * `ValidationArrayToFluentRuleRector` at decision-point bails. Each
 ...
 * (per spec §4.4a). Mirrors `StringConverterSkipLogTest` and
 * `GroupWildcardSkipLogTest`. New skip-emit sites add new
 * data-provider rows here.
 */
final class ArrayConverterSkipLogTest extends AbstractRectorTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tempCwd = sys_get_temp_dir() . '/array-converter-skiplog-' . uniqid('', true);
    ...
    {
        $reflection = new ReflectionClass(ValidationArrayToFluentRuleRector::class);
